...
const PetroleraDashboardOverview: React.FC<PetroleraDashboardOverviewProps> = ({ user }) => {
  ...
  return (
    <div className="p-4 md:p-6 lg:p-10 space-y-6 md:space-y-10 animate-in fade-in duration-700">
      {/* Header */}
      <div className="rounded-[2rem] md:rounded-[2.5rem] bg-slate-900 p-6 md:p-10 text-white relative overflow-hidden shadow-2xl">
         <div className="relative z-10">
            <h1 className="text-2xl md:text-3xl font-black uppercase tracking-tighter break-words">Portal de Operadora</h1>
         ...
         <div className="absolute right-0 top-0 p-6 md:p-10 opacity-10">
            <span className="material-symbols-outlined text-[60px] md:text-[100px]">oil_barrel</span>
         </div>
      </div>
