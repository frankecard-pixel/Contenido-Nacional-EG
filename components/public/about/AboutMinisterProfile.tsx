...
const AboutMinisterProfile: React.FC = () => {
  ...
  return (
    <section className="mb-20 md:mb-32 py-12 md:py-20 bg-slate-950 rounded-[2.5rem] md:rounded-[4rem] px-6 md:px-12 lg:px-24 border border-white/5 text-white">
       <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-center">
          <div className="lg:col-span-4">
             <div className="aspect-[3/4] rounded-[2rem] md:rounded-[3rem] overflow-hidden shadow-2xl border-4 md:border-8 border-white/5">
                <img 
                  src={ministerPhoto} 
          ...
          <div className="lg:col-span-8">
             ...
             <div className="space-y-6 text-slate-300 text-base md:text-lg leading-relaxed opacity-90 font-medium italic">
                <p>
                   Bajo la dirección del Excmo. Sr. Ministro Antonio Oburu Ondo, el Ministerio de Hidrocarburos y Desarrollo Minero ha priorizado la implementación efectiva del Reglamento de Contenido Nacional, asegurando que las operadoras petroleras cumplan con los más altos estándares de participación local.
                </p>
                <p>
