    ...
    <section className="py-24 border-t border-slate-100">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <p className="text-slate-500 leading-relaxed mb-12">
          Anualmente, el Ministerio de Hidrocarburos y Desarrollo Minero otorga becas de especialización para los técnicos con mejor desempeño en los centros nacionales para estancias en centros internacionales de alta tecnología.
        </p>
