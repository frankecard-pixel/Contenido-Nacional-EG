      ...
      <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-slate-900 via-slate-950 to-blue-950 p-6 sm:p-10 md:p-12 text-white shadow-2xl border border-slate-800">
        ...
        <div className="relative z-10 max-w-3xl mx-auto text-center">
          ...
          <div className="inline-flex items-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-1 sm:py-1.5 rounded-full bg-blue-500/10 border border-blue-500/20 text-blue-300 text-[9px] sm:text-[10px] font-black uppercase tracking-[0.15em] sm:tracking-[0.2em] mb-3 sm:mb-4">
            ...
            Reserva de Empleo Local &bull; Ley de Contenido Nacional
          </div>

          <h3 className="text-xl sm:text-3xl md:text-4xl font-black uppercase tracking-tight text-white mb-3 sm:mb-4 leading-tight">
            ¿Desea Aplicar a este Puesto de Empleo?
          </h3>

          <p className="text-slate-300 text-xs sm:text-sm md:text-base leading-relaxed font-medium mb-6 sm:mb-8 max-w-2xl mx-auto">
            En estricto cumplimiento del Reglamento de la <strong className="text-white">Ley de Contenido Nacional de Guinea Ecuatorial</strong>, la postulación directa y la remisión de expedientes laborales están reservadas a profesionales registrados en la plataforma <strong className="text-white">RUGE (Registro Único de Contenido Nacional)</strong>.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-center gap-3 sm:gap-4 mb-8 sm:mb-10">
            ...
            >
              ...
              <span>{t('common.register') || 'Crear Cuenta de Talento'}</span>
            </Link>
          </div>
          ...
          <div className="border-t border-white/10 pt-6 sm:pt-8 grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 text-left">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h4 className="text-xs font-black uppercase tracking-wider text-white">Perfil Verificado</h4>
                <p className="text-[11px] text-slate-400 mt-0.5">Validación de títulos y certificaciones laborales oficiales.</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              <CheckCircle2 className="size-4 sm:size-5 text-emerald-400 shrink-0 mt-0.5" />
              <div>
                <h4 className="text-xs font-black uppercase tracking-wider text-white">Prioridad Nacional</h4>
                <p className="text-[11px] text-slate-400 mt-0.5">Acceso directo a contrataciones preferentes en el sector hidrocarburífero.</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              <CheckCircle2 className="size-4 sm:size-5 text-emerald-400 shrink-0 mt-0.5" />
              <div>
                <h4 className="text-xs font-black uppercase tracking-wider text-white">Seguimiento Real</h4>
                <p className="text-[11px] text-slate-400 mt-0.5">Notificaciones sobre el avance del proceso de selección por parte de la empresa.</p>
              </div>
            </div>
          </div>
        </div>
